                        ...
                        <div class="card-body card-block">
                            <div class="row form-group">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="numeric" name="precio" id="precio" placeholder="precio " class="form-control"></div>
                            ...
                            <div class="row form-group">
                                <div class="col-6">
                                    ...
                                    <input type="numeric" name="cantidad" id="cantidad" placeholder="Cantidad en stock" class="form-control">
